...
export default function CheckinPublico() {
  ...
  async function enviar() {
    ...
    const adherencia = form.sesiones_planificadas && form.sesiones_semana !== null
      ? Math.min(10, Math.max(1, Math.round((form.sesiones_semana / form.sesiones_planificadas) * 10)))
      : null
        ...
        {paso === 2 && (
          <>
            ...
            {[
              ...
              { field: 'estres', label: '🧠 Estrés o carga mental', desc: 'Trabajo, estudios, vida personal…', opciones: [[1,'Tranquilo'],[2,'Leve'],[3,'Moderado'],[4,'Alto'],[5,'Al límite']], red: true },
              { field: 'fatiga', label: '💪 Fatiga muscular', desc: 'Cómo notas el cuerpo físicamente', opciones: [[1,'Ninguna'],[2,'Leve'],[3,'Moderada'],[4,'Alta'],[5,'Al límite']], red: true },
          ...
          <>
            ...
            <div className="bg-[#F0EEE8] rounded-2xl p-4 space-y-2">
              ...
              {[
                ...
                ['🧠 Estrés', form.estres ? form.estres + '/5' : '—'],
                ['💪 Fatiga', form.fatiga ? form.fatiga + '/5' : '—'],
              ].map(([k,v]) => (
